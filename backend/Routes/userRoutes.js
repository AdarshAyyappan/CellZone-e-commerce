...
import {protect,admin,isBlocked} from '../middleware/authMiddleware.js'
...
router.route('/profile').get(protect,isBlocked,getUserProfile).put(protect,updateUserProfile)
