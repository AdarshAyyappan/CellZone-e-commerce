  ...
  return (
    <footer className="bg-dark text-center text-lg-start">
        ...
        <div className='container text-center text-md-start mt-5'>
          <div className='row mt-3'>
            ...
            {/* <img width="50"  className='mx-2' style={{ borderRadius: '50%' }}  src="https://media.istockphoto.com/vectors/running-shoe-heart-symbol-on-white-backdrop-vector-id1212219150?k=20&m=1212219150&s=612x612&w=0&h=HDUBBEueWigtu3f7ne8mZFbJmjtfzGqSdSLIgmw5-Lw=" alt="" /> */}
              ...
              www.cell zone.com has launched with many innovative features to ensure that users get an immersive experience of the buying Online Mobiles .
              </p>
            </div>
            ...
            <div className='col-md-2 col-lg-2 col-xl-2  mx-auto mb-4'>
              ...
              <p className='text-white'>
                <Link className='text-white' to={'/'}>Iphone</Link>
                
              </p >
              <p className='text-white'>
              <Link className='text-white' to={'/'}>Realme</Link>

              </p>
              <p className='text-white'>
              <Link className='text-white' to={'/'}>Redmi</Link>

              </p>
              <p className='text-white'>
              <Link className='text-white' to={'/'}>Samsung</Link>

              </p>
              <p className='text-white'>
              <Link className='text-white' to={'/'}>Motrola</Link>
            ...
            <div className='col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4'>
              ...
              <p className='text-white h6'>
              <i class="fa-solid fa-envelope"> info@cellzone.com</i>
      ...
      <div className='text-center text-white p-4' style={{ backgroundColor: 'rgba(0, 0, 0, 0.05)' }}>
        © 2021 Copyright:  Developed By  <Link className='text-info' to={'/'}>ADARSH S NAIR</Link><br></br>
       
        <Link className='text-info' to={'/'}> www.CellZone.com</Link>
