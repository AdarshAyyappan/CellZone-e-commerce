    ...
    <header>
      ...
      >
        ...
        {/* <LinkContainer to="/" style={{ color: 'white', fontWeight: 'bold', fontSize: '1.5rem',borderRadius:"50%" }}>
            <img width="50"  src="http://wonderfulengineering.com/wp-content/uploads/2014/07/cellphone-wallpaper-15-610x915.jpg" alt="" />
          </LinkContainer> */}


          <LinkContainer to="/" style={{ color: 'white', fontWeight: 'bold', fontSize: '1.5rem' }}>
            <Navbar.Brand className='ml-1 text-uppercase '><span>cell<span className='text-danger'>Z</span>one</span></Navbar.Brand>
            ...
            <Nav className='ml-auto' >
              ...
              {userInfo ? (
                userInfo.isAdmin ? "":(<NavDropdown
                  ...
                  title={ 
                    <img  alt="Remy Sharp" className='my-auto'  style={{ borderRadius: '50%' ,width:"60px" }}src="https://png.pngitem.com/pimgs/s/508-5087275_profile-icon-large-squeegee-hd-png-download.png" ></img>
